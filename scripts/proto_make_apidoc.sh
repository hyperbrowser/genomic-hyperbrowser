...
# Temporarily remove all comments in ToolTemplate.py
cp proto/tools/ToolTemplate.py proto/tools/ToolTemplate.py.orig
...
cp $LIB_DIR/proto/tools/ToolTemplate.py.orig $LIB_DIR/proto/tools/ToolTemplate.py
