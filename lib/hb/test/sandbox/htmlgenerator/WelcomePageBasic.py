...
#     DEMO_GWAS_BLUPRINT_TRACK_PLACEHOLDER = "__dt_gwas__"
    ...
    PLACEHOLDERS_DICT = {
                        TRACK_VS_COLLECTION_TOOL_PLACEHOLDER : (TRACK_VS_COLLECTION_TOOL_URL, TRACK_VS_COLLECTION_TOOL_TITLE, TRACK_VS_COLLECTION_TOOL_HOVER, False, True, False),
                        COLLECTION_TOOL_PLACEHOLDER : (COLLECTION_TOOL_URL, COLLECTION_TOOL_TITLE, COLLECTION_TOOL_HOVER, False, True, False),
                        COLLECTION_VS_COLLECTION_TOOL_PLACEHOLDER : (COLLECTION_VS_COLLECTION_TOOL_URL, COLLECTION_VS_COLLECTION_TOOL_TITLE, COLLECTION_VS_COLLECTION_TOOL_HOVER, False, True, False),
                        ...
                        OVERLAP_BETWEEN_TRACKS_PLACEHOLDER : (OVERLAP_BETWEEN_TRACKS_URL, OVERLAP_BETWEEN_TRACKS_TITLE, OVERLAP_BETWEEN_TRACKS_HOVER, False, True, False),
                        ...
                        SIMILARITY_AND_UNIQUENESS_PLACEHOLDER : (SIMILARITY_AND_UNIQUENESS_URL, SIMILARITY_AND_UNIQUENESS_TITLE, SIMILARITY_AND_UNIQUENESS_HOVER, False, True, False),
...
#                         DEMO_GWAS_BLUPRINT_TRACK_PLACEHOLDER : (DEMO_GWAS_BLUPRINT_TRACK_URL, DEMO_GWAS_BLUPRINT_TRACK_TITLE, DEMO_GWAS_BLUPRINT_TRACK_HOVER, True, False, False),
                        ...
                        CLUS_TRACK_TOOL_PLACEHOLDER : (CLUS_TRACK_TOOL_URL, CLUS_TRACK_TOOL_TITLE, CLUS_TRACK_TOOL_HOVER, False, False, False),
                        ...
                        MATCH_TF_WITH_PWMS_TOOL_PLACEHOLDER : (MATCH_TF_WITH_PWMS_TOOL_URL, MATCH_TF_WITH_PWMS_TOOL_TITLE, MATCH_TF_WITH_PWMS_TOOL_HOVER, False, True, False),
                        ...
                        GSUITE_TRACKS_VS_GSUITE_TOOL_PLACEHOLDER : (GSUITE_TRACKS_VS_GSUITE_TOOL_URL, GSUITE_TRACKS_VS_GSUITE_TOOL_TITLE, GSUITE_TRACKS_VS_GSUITE_TOOL_HOVER, False, True, False),
                        DEMO_TRACK_LICA_CN_PLACEHOLDER : (DEMO_TRACK_LICA_CN_URL, DEMO_TRACK_LICA_CN_TITLE, DEMO_TRACK_LICA_CN_HOVER, True, False, False),
                        ALL_TARGETS_OF_TFS_TOOL_PLACEHOLDER : (ALL_TARGETS_OF_TFS_TOOL_URL, ALL_TFS_OF_REGION_TOOL_TITLE, ALL_TARGETS_OF_TFS_TOOL_HOVER, False, True, False),
                        ALL_TFS_OF_REGION_TOOL_PLACEHOLDER : (ALL_TFS_OF_REGION_TOOL_URL, ALL_TFS_OF_REGION_TOOL_TITLE, ALL_TFS_OF_REGION_TOOL_HOVER, False, True, False),
                        TF_BINDING_DISRUPTION_TOOL_PLACEHOLDER : (TF_BINDING_DISRUPTION_TOOL_URL, TF_BINDING_DISRUPTION_TOOL_TITLE, TF_BINDING_DISRUPTION_TOOL_HOVER, False, False, False)
                         }
