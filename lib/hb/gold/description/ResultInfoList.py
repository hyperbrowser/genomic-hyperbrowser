...
GenericResultsCombinerStat_Both = ('Base pairs covered by both', 'The number of base pairs covered by both tracks (i.e. their overlap at the base pair level)')
GenericResultsCombinerStat_Neither = ('Base pairs uncovered', 'The number of base pairs not covered by any of the two tracks')
GenericResultsCombinerStat_Only1 = ('Base pairs covered by only track1', 'The number of base pairs covered by only track1')
GenericResultsCombinerStat_Only2 = ('Base pairs covered by only track2', 'The number of base pairs covered by only track2')
GenericResultsCombinerStat_track1_count = ('Number of track1-points', '')
GenericResultsCombinerStat_track2_count = ('Number of track2-points', '')
GenericResultsCombinerStat_SingleValExtractorStat = ('Forbes coefficient', 'Forbes coefficient: ratio of observed to expected overlap')
ObservedVsExpectedStat_Result = ('Forbes coefficient', 'Forbes coefficient: ratio of observed to expected overlap')
