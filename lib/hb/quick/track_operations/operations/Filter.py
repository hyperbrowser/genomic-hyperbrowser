    ...
    def _getKwArgumentInfoDict(self):
        return OrderedDict([
            ...
            ('debug', KwArgumentInfo('debug', False, 'Print debug info', bool,
                                     False)),
            ('removeStrands',
             KwArgumentInfo('removeStrands', False, 'Remove all strands',
                            bool, False)),
            ('removeValues',
             KwArgumentInfo('removeValues', False, 'Remove all values',
                            bool, False)),
            ('removeLinks',
             KwArgumentInfo('removeLinks', False,
                            'Remove all link info, if present.', bool, False)),
            ('removeWeights',
             KwArgumentInfo('removeWeights', False,
                            'Remove all weight info, if present.',
                            bool, False)),
            ('removeExtras',
             KwArgumentInfo('removeExtras', False,
