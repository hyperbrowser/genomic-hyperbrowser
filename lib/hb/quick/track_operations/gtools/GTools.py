...
#from quick.api.BTrack import BTrack
#from quick.api.CommandParser import CommandParser
...
from quick.track_operations.operations.Operator import getOperation, Operator
