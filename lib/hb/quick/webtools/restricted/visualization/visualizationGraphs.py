...
class visualizationGraphs(object):
    ...
    def _buildContainer(self, addOptions, addTable, titleText):
        ...
        table = ''
        if addTable == True:
            table += str('''<div id="table_''' + ".".join(titleText.replace("'", "").replace('"',
        ...
        table += str('''<div id="container''' + str(self.__class__.count) + '''" style= "''' + str(
            addOptions) + '''"></div>''')
        if addTable == True:
            table += '</div>'
    ...
    def _addGuideline(self, htmlCore):
        ...
        """)
        htmlCore.divBegin('plotDivd',
                          style="min-width:400px;border:1px solid #000033;padding:10px;color:#181818")
        htmlCore.divBegin('guideLine',
                          style="font-weght:bold;text-transform:uppercase;margin-bottom:5px;")
        ...
        htmlCore.divEnd()
        htmlCore.line(
            '- To zoom a plot representing one dataset, e.g. one line, click on the plot and drag your mouse to the left/right side.')
        htmlCore.line(
            '- To zoom when viewing multiple plots that represent related datasets, in the same output page, zooming one plot will automatically zoom all plots.')
    ...
    def addTable(self, name, tableName, option, indexSpecial):
        ...
        if type(name) is str:
            ...
            n = name
            nVal = 'table_' + str(".".join(n.replace("'", "").replace('"', "").split()))
            strJs = "'" + '<input type="checkbox"  checked="checked" name="tabResList" id ="' + str(
                inx) + '" value="' + nVal + '"' + ' onclick=showMe("' + nVal + '")' + '\>' + "';"
            table += 'document.getElementById("' + str(
                tableName) + '").getElementsByTagName("th")[' + str(
                inx + 1) + '].innerHTML += ' + strJs
            inx += 1
        else:
            inx = indexSpecial
            for n in name:
    ...
    def _parseData(self, dataY, type, seriesType, seriesName, multiYAxis, visible, yAxisMulti,
                   multiXAxis, xAxisMulti, markerRadius):
        ...
        if isinstance(dataY[0], list) == True:
                ...
                for d in dataY:
                    ...
                    if i == 0:
                        ...
                        data = '{0}{1}{2}{3}{4}{5}'.format(
                            """ color: '""" + colorsList[j] + """', """ + """ type: '""" +
                            seriesType[0] + """', """ + """ """,
                            visible + marker1 + """  name: """,
                            "'" if seriesName == '' else "'" + seriesName[i], """', data: """, d,
                            """ } """)
                    else:
                        yAxisMultiVal = str(i)
                        ...
                        if seriesType[i] != 'scatter':
                            ...
                            marker1 = marker
                        data = data + '{0}{1}{2}{3}{4}{5}{6}'.format(
                            """ , { """ + """ color: '""" + colorsList[
                                j] + """', """ + """ type: '""" + seriesType[i] + """', """,
                            """yAxis: """ + str(yAxisMultiVal) + """ ,""",
                            visible + marker1 + """name: """,
                            "'" if seriesName == '' else "'" + seriesName[i], """', data: """, d,
                            """ } """)
            ...
            data = '{0}{1}{2}{3}{4}{5}'.format(""" type: '""" + seriesType[0] + """', """,
                                               visible + marker + """  name: """,
                                               "'" if seriesName == '' else "'" + seriesName[0],
                                               """', data: """, dataY, """ } """)
    ...
    def _parseData4(self, dataY):
        ...
        if isinstance(dataY[0], list) == True:
            ...
            for eldY1 in range(0, len(dataY)):
                column = 0
                for eldY2 in range(0, len(dataY[eldY1])):
                    dataList += str(column) + ',' + str(row) + ',' + str(
                        dataY[eldY1][eldY2]) + '\n'
                    column += 1
                row += 1
    ...
    def _parseData5(self, dataY, type, seriesType, seriesName, markerRadius, colorExtraList):
        ...
        if isinstance(dataY[0], list) == False:
            for eldY in range(0, len(dataY)):
                ...
                data += " name: " + str(sN) + ", data: [" + str(d) + "]" + (ifColor) + str(marker)
    ...
    def _useXAxis(self, xAxisTitle, tickInterval, tickMinValue, categories, typeAxisXScale, \
        ...
        if plotLines != None:
            ...
            if isinstance(plotLines, list):
                ...
                for el in plotLines:
                    ...
                    width: """ + str(width) + """,
                    label: { text: '""" + str(plName) + """', style: { color:'""" + str(
                        plotBandsColorV) + """' },
                    }
                    },
                    """
        ...
        if type == 'heatmap' or type == 'largeHeatmap':
            if categories != None and categories != '':
                ...
                cat = ''
            xAxis = """ xAxis: { labels: {rotation: """ + str(xAxisRotation) + """ },  """ + str(
                cat)
        ...
        if histogram == True:
            ...
            for elN in range(0, len(categories)):
                if elN > 0:
                    categoriesNew.append(
                        '> ' + str(categories[elN - 1]) + ' =< ' + str(categories[elN]))
            ...
            if multiXAxis == True:
                ...
                for wel in range(0, len(xAxisMulti)):
                    ...
                    xAxis += """
                         ...
                         """ + self._useAttribute2(tickInterval, "tickInterval")
                ...
                xAxis = """
                 xAxis: {
                  ...
                  """ + self._useAttribute2(tickInterval, "tickInterval") + self._useAttribute4(
                    tickMinValue, "min") + categories + self._useAttribute1(typeAxisXScale,
                                                                            "type") + """
                  labels: {
                      """ + self._useAttribute1(xAxisRotation, "rotation") + """
                  }
    ...
    def _useChart(self, height, polar, marginTop, zoomType, countNum, type):
        ...
        chart: {
                ...
                renderTo: 'container""" + str(self.__class__.count) + """',
                isZoomed:false,
                """ + self._useAttribute5(zoomType, 'zoomType') + self._useAttribute3(polar,
                                                                                      'polar',
                                                                                      'true') + self._useAttribute5(
                marginTop, 'marginTop') + """
            """
    ...
    def _usePlotOptions(self, type, stacking, lineWidth, dataLabels, showInLegend, extraArg,
        ...
        if extraArg is None:
            ...
            plotOptions: {
                    """ + type + """: {
                        """ + str(showInLegend) + histogram + self._useAttribute3(stacking,
                                                                                  "stacking",
                                                                                  'normal') + self._useAttribute5(
                lineWidth, 'lineWidth') + dataLabels + plotOptions + """
                    }
                },
            """
        if extraArg == 'pie':
    ...
    def _addButton(self, name):
        return '<div class="buttonArea"><input type="button" name="1" id="button' + str(
            self.__class__.count) + '" value="' + str(name) + '" ></input></div>';

    def _draw(self, dataY, legendSize, legendSizeExtra, type, height, addOptions, tickInterval,
              tickMinValue, label, lineWidth, titleText, subtitleText, xAxisTitle, yAxisTitle,
              categories,
              legend, xAxisRotation, dataLabels, polar, stacking, shared, overMouseAxisX,
              overMouseLabelX, showChartClickOnLink, typeAxisXScale, pointStartLog, zoomType,
              marginTop,
              interaction, multiYAxis, multiXAxis, xAxisMulti, showInLegend, extraArg,
              allowDecimals, maxY, yAxisType, extraScriptButton, addTable, histogram,
              sortableAccordingToTable, sortableAccordingToTableDataY, tableName,
              sortableAccordingToTableIndexWithTrackTitle, plotOptions, tooltipVal, reversed, minY,
              plotLines, categoriesY, plotLinesName,
        ...
        if legendSize != '':
            ...
            legendSize = """maxHeight: """ + str(legendSizeExtra) + """, itemWidth: """ + str(
                legendSize) + ","
        ...
        #             """
            ...
            legend = """ legend: { """ + str(legend) + str(
                legendSize) + 'itemMarginBottom: 10,' + """},"""
        ...
        if type == 'largeHeatmap':
            ...
            functionJS1 = " <script> $(function () { " + self._themePlot() + self._addToLargeHeatmap() + catNew + "chart" + str(
                self.__class__.count) + " = new Highcharts.Chart({"
        else:
            functionJS1 = " <script> $(function () { " + self._themePlot() + "chart" + str(
                self.__class__.count) + " = new Highcharts.Chart({"

        functionJS1 += str(
            self._useChart(height, polar, marginTop, zoomType, self.__class__.count, type))
        functionJS1 += str(self._useTitle(titleText))
        functionJS1 += str(self._useSubTitle(subtitleText))
        functionJS1 += str(
            self._useXAxis(xAxisTitle, tickInterval, tickMinValue, categories, typeAxisXScale,
                           xAxisRotation, \
        ...
        if multiYAxis == True:
            ...
            functionJS1 += str(
                self._useYAxis(yAxisTitle, allowDecimals, maxY, yAxisType, minY, type,
                               categoriesY))

        if type != 'bubble' and type != 'heatmap':
            functionJS1 += str(
                self._usePlotOptions(type, stacking, lineWidth, dataLabels, showInLegend, extraArg,
                                     histogram, plotOptions))
        functionJS1 += str(
        ...
        if extraScriptButton is None:
            ...
            if extraScriptButton[1]:
                if extraScriptButton[1] == 'yAxisType':
                    extraSc1 = """chart.yAxis[0].update({ type: '""" + extraScriptButton[0][
                        extraScriptButton[0].keys()[1]] + """'});"""
                    extraSc2 = """chart.yAxis[0].update({ type: '""" + extraScriptButton[0][
                        extraScriptButton[0].keys()[0]] + """'});"""
            ...
            extraScriptButton = """\n
                 ...
                 {
                    document.getElementById('button""" + str(
                self.__class__.count) + """').value = '""" + extraScriptButton[0].keys()[0] + """';
                    """ + extraSc1 + """
                 ...
                 {
                    document.getElementById('button""" + str(
                self.__class__.count) + """').value = '""" + extraScriptButton[0].keys()[1] + """';
                    """ + extraSc2 + """
        ...
        if type == 'largeHeatmap':
            return '{0}{1}{2}{3}{4}'.format(button, jsCodeShowChartClickOnLink, container,
                                            functionJS1, functionJS2)
        elif type == 'boxplot':
    ...
    def drawLineChart(self,
        ...
        if len(dataY) > 0:
            ...
            data, legendSize, legendSizeExtra = self._parseData(dataY=dataY, type=type,
                                                                ...
                                                                multiYAxis=False,
                                                                visible=visible, yAxisMulti=None,
                                                                multiXAxis=False, xAxisMulti=None,
                                                                markerRadius=None)
    ...
    def drawHeatmapLargeChart(self,
        ...
        if len(dataY) > 0:
            ...
            graph += self._draw(
                ...
                categoriesY=categoriesY, plotLinesName=None,
                plotBands=None,
                plotBandsColor=None
            )
        ...
        if len(dataY) > 0:
            ...
            if sortableAccordingToTableDataY is None:
                ...
                if addTable == True:
                    ...
                    graph += self.addTable(titleText, tableName=tableName, option=2,
                                           indexSpecial=sortableAccordingToTableIndexWithTrackTitle)
                    addTable = 'option2'
    ...
    def drawLineChartMultiYAxis(self,
        ...
        if len(dataY) > 0:
            ...
            data, legendSize, legendSizeExtra = self._parseData(dataY=dataY, type='line',
                                                                seriesType=seriesType,
                                                                seriesName=seriesName,
                                                                multiYAxis=True,
                                                                visible=visible,
    ...
    def drawPieChart(self, dataY, height=None, addOptions=None,
        ...
        if len(dataY) > 0:
            ...
            data, legendSize, legendSizeExtra = self._parseData2(dataY=dataY, type='pie',
                                                                 seriesType=seriesType,
                                                                 seriesName=seriesName)
            ...
            graph = self._draw(
                ...
                sortableAccordingToTableIndexWithTrackTitle=None,
                plotOptions=None,
                tooltipVal=tooltipVal, reversed=None, minY=None, plotLines=None, categoriesY=None,
                plotLinesName=None,
                plotBands=None,
                plotBandsColor=None
    ...
    def drawColumnCharts(self,
        ...
        if len(dataY) > 0:
            ...
            if addTable == True:
                if tableName is None:
                    tableName = 'resultsTable'
                graph += self.addTable(titleText, tableName=tableName, option=1,
                                       indexSpecial=sortableAccordingToTableIndexWithTrackTitle)
            ...
            if dataYdepth >= 2:
                for eldY in range(0, len(dataY)):
                    ...
                    graph += self.drawColumnChart(dataY[eldY], height=height,
                                                  addOptions=addOptions, tickInterval=tickInterval,
                                                  label=label, lineWidth=lineWidth, titleText=tT,
                                                  subtitleText=subtitleText, xAxisTitle=xAxisTitle,
                                                  yAxisTitle=yAxisTitle,
                                                  categories=cat, seriesType=seriesType,
                                                  seriesName=sN,
                                                  legend=legend, xAxisRotation=xAxisRotation,
                                                  dataLabels=dataLabels,
                                                  shared=shared, overMouseAxisX=overMouseAxisX,
                                                  overMouseLabelX=overMouseLabelX,
                                                  showChartClickOnLink=showChartClickOnLink,
                                                  typeAxisXScale=typeAxisXScale,
                                                  pointStartLog=pointStartLog,
                                                  ...
                                                  tableName=tableName,
                                                  sortableAccordingToTableIndexWithTrackTitle=sortableAccordingToTableIndexWithTrackTitle,
                                                  plotOptions=plotOptions, minY=minY,
                                                  plotLines=pLine, plotLinesName=pLineName,
                                                  plotBands=None,
                                                  plotBandsColor=None
                                                  )
            else:
                graph += self.drawColumnChart(dataY, height=height, addOptions=addOptions,
                                              tickInterval=tickInterval,
                                              ...
                                              sortableAccordingToTableIndexWithTrackTitle=sortableAccordingToTableIndexWithTrackTitle,
                                              plotOptions=plotOptions, minY=minY,
                                              plotLines=plotLines, plotLinesName=plotLinesName,
                                              plotBands=None,
                                              plotBandsColor=None
                                              )
        ...
        if len(dataY) > 0:
            ...
            if dataYdepth >= 2:
                ...
                for eldY in range(0, len(dataY)):
                    ...
                    graph += self.drawBubbleChart(dataY[eldY], height=height,
                                                  addOptions=addOptions, tickInterval=tickInterval,
                                                  label=label, lineWidth=lineWidth, titleText=tT,
                                                  subtitleText=subtitleText, xAxisTitle=xAxisTitle,
                                                  yAxisTitle=yAxisTitle,
                ...
                graph += self.drawBubbleChart(dataY, height=height, addOptions=addOptions,
                                              tickInterval=tickInterval,
                                              label=label, lineWidth=lineWidth,
                                              titleText=titleText, subtitleText=subtitleText,
                                              xAxisTitle=xAxisTitle, yAxisTitle=yAxisTitle,
                                              ...
                                              visible=visible,
                                              addTable=addTable,
                                              tableName=tableName, minY=minY, plotLines=plotLines,
                                              plotLinesName=plotLinesName
                                              )
        return str(graph) + '<div style="clear:both"></div>'

    def drawPieCharts(self, dataY, height=None, addOptions=None, seriesType=None,
                      seriesName=None, showInLegend=True, extraArg='pie', titleText=None,
                      addTable=None):
        ...
        if len(dataY) > 0:
            ...
            if dataYdepth >= 2:
                for eldY in range(0, len(dataY)):
                    ...
                    graph += self.drawPieChart(dataY[eldY], height=height, addOptions=addOptions,
                                               seriesType=seriesType, seriesName=sN,
                                               showInLegend=showInLegend, extraArg=extraArg,
                                               titleText=titleText, addTable=addTable)
        ...
        if len(dataY) > 0:
            ...
            if dataYdepth > 2:
                ...
                if interaction == True:
                    ...
                    graph += """<button id="btn""" + str(
                        self._interactionNumberStart) + """" >UNZOOM</button>"""
                    graph += """<style>
                ...
                for eldY in range(0, len(dataY)):
                    ...
                    graph += self.drawLineChart(dataY[eldY], height=height, addOptions=addOptions,
                                                tickInterval=tickInterval,
                                                tickMinValue=tickMinValue,
                                                label=label, lineWidth=lineWidth,
                                                titleText=titleText, subtitleText=subtitleText,
                                                ...
                                                maxY=maxY,
                                                visible=visible,
                                                addTable=addTable, minY=minY, plotLines=pLine,
                                                plotLinesName=pLineName,
                                                plotBands=None,
                                                plotBandsColor=None
                                                )
                ...
                graph += self.drawLineChart(dataY, height=height, addOptions=addOptions,
                                            tickInterval=tickInterval, tickMinValue=tickMinValue,
                                            label=label, lineWidth=lineWidth, titleText=titleText,
                                            subtitleText=subtitleText, xAxisTitle=xAxisTitle,
                                            yAxisTitle=yAxisTitle,
                                            categories=categories, seriesType=seriesType,
                                            seriesName=seriesName,
                                            ...
                                            maxY=maxY,
                                            visible=visible,
                                            addTable=addTable, minY=minY, plotLines=plotLines,
                                            plotLinesName=plotLinesName,
                                            plotBands=None,
                                            plotBandsColor=None
                                            )
...
class plotFunction(object):
    ...
    def hideColumns(self, indexList):
        ...
        //console.log(document.getElementById('""" + str(
            self._tableId) + """').getElementsByTagName("td"), document.getElementById('""" + str(
            self._tableId) + """').getElementsByTagName("td").length);
        ...
        < script
        src = "https://code.highcharts.com/modules/data.js" > < / script >
        < script
        src = "https://code.highcharts.com/modules/heatmap.js" > < / script >
        < script
        src = "https://code.highcharts.com/modules/exporting.js" > < / script >
        < script
        src = "https://raw.github.com/briancray/tooltipsy/master/tooltipsy.min.js" > < / script >
        < script
...
return """
    ...
    *- Use
    ...
    of
    SVG
    for rendering of the heatmap squares.Canvas
    *outperforms
    SVG
    when
    it
    ...
    * /
    ...
    this.canvas.setAttribute('width', this.chart.chartWidth);
    this.canvas.setAttribute('height', this.chart.chartHeight);
    this.image = this.chart.renderer.image('', 0, 0, this.chart.chartWidth,
...
def _addStyle(self):
    ...
    < / style >
        ...
        function
    sortTwoLists(A, B, namesFromTable, type)
    {
    ...
    function
    sortListAccordingToOtherList(A, D)
    {
    var
    C = [];
    for (var i = 0; i < A.length; i++)
...
def _addGuideline(self, htmlCore):
    ...
    class ="clickme" > Show instructions for plots < / a >
...
strText = """
    ...
    class ="infomessage" > < div class ='""" + str(tableName) + """clickme' > Show instruction for plots < / div > < / div >

    """

strText += """
    < div
    id = '""" + str(tableName) + """plot'
    style = 'display:none;min-width:400px;margin-top:10px;border:1px solid #000033;padding:10px;color:#181818' >
    < div
    id = 'guideLine'
    style = 'font-weght:bold;text-transform:uppercase;margin-bottom:5px;' >
    Guidelines
    ...
    < div
    id = 'option1d'
    style = 'font-weght:bold;margin-bottom:5px;margin-top:5px;' >
    Sorting:
    < / div >
    ...
    using
    ctrl / cmd) and press
    the \"Get selected regions\" button. The .bed file/files will appear above the heatmap where they can be downloaded.
...
#         table += """
    ...
    table += """
                                        <input type="hidden" name="checkedVal" id="checkedVal" value=""" + str(
            noChecked) + """>
    ...
    def _useXAxis(self, xAxisTitle, tickInterval, tickMinValue, categories, typeAxisXScale, \
            ...
            if type == 'heatmap' or type == 'largeHeatmap':
                    if categories != None and categories != '':
                            ...
                            cat = ''
                    xAxis = """ xAxis: { labels: {rotation: """ + str(
                            xAxisRotation) + """ },  """ + str(cat)
                    ...
                    if multiXAxis == True:
                            ...
                            for wel in range(0, len(xAxisMulti)):
                                    ...
                                    if wel == 0:
                                            ...
                                            leftVal = 'left:' + str(
                                                    leftVal) + ', offset:0,' + 'width: 100,'

                                    xAxis += """
                                                         {
                                                         """ + str(minX) + str(plotLines) + str(
                                            leftVal) + """
                                                         title: {
                                                         """ + self._useAttribute1(xAxisTitle,
                                                                                   "text") + """
                                                         },
                            ...
                            xAxis = """
                                                 xAxis: {
                                                  ...
                                                  """ + self._useAttribute2(tickInterval,
                                                                            "tickInterval") + self._useAttribute4(
                                    tickMinValue, "min") + categories + self._useAttribute1(
                                    typeAxisXScale, "type") + """
                                                  labels: {
    ...
    def _useChart(self, height, polar, marginTop, zoomType, countNum, type):
            ...
            if type == 'heatmap' or type == 'largeHeatmap':
                    chart = """
                                                chart: {
                                                height: """ + str(
                            height) + """, """ + self._useAttribute5(zoomType, 'zoomType') + """
                                                renderTo: 'container""" + str(
                    ...
                    chart = """
                            ...
                            self.__class__.count) + """',
                                                isZoomed:false,
                                                """ + self._useAttribute5(zoomType,
                                                                          'zoomType') + self._useAttribute3(
                            polar, 'polar', 'true') + self._useAttribute5(marginTop, 'marginTop') + """
                                            """
            if type == 'pie' or type == 'scatter' or type == 'heatmap' or type == 'boxplot':
                    chart += "type: '" + str(type) + "',"
            if type == 'largeHeatmap':
            ...
            if extraArg is None:
                    return """
                                            plotOptions: {
                                                    """ + type + """: {
                                                        """ + str(
                            showInLegend) + histogram + self._useAttribute3(stacking, "stacking",
                                                                            'normal') + self._useAttribute5(
                            lineWidth, 'lineWidth') + dataLabels + plotOptions + """
                                                    }
                                                },
    ...
    def _draw(self, dataY, legendSize, legendSizeExtra, type, height, addOptions, tickInterval,
            ...
            if legendSize != '':
                    legendSize = legendSize * 6 + 36
                    legendSizeExtra = legendSizeExtra + 100
                    legendSize = """maxHeight: """ + str(
                            legendSizeExtra) + """, itemWidth: """ + str(legendSize) + ","
            ...
            functionJS1 += str(self._useTitle(titleText))
            functionJS1 += str(self._useSubTitle(subtitleText))
            functionJS1 += str(self._useXAxis(xAxisTitle, tickInterval, tickMinValue, categories,
                                              typeAxisXScale, xAxisRotation, \
                                              labelX, interaction, type, histogram, plotLines,
                                              plotLinesName,
                                              plotBands, plotBandsColor, multiXAxis, xAxisMulti))
            ...
            if type != 'bubble' and type != 'heatmap':
                    functionJS1 += str(self._usePlotOptions(type, stacking, lineWidth, dataLabels,
                                                            showInLegend, extraArg, histogram,
                                                            plotOptions))
            functionJS1 += str(self._useToolTip(label, shared, extraArg, tooltipVal, histogram,
                                                extraScriptButton, type))
            functionJS1 += legend
            ...
            if type == 'largeHeatmap':
                    ...
                    functionJS1 += " series: [{ " + self._useAttribute4(pointStartLog,
                                                                        "pointStart")
            ...
            if extraScriptButton is None:
                    ...
                    if extraScriptButton[1]:
                            if extraScriptButton[1] == 'yAxisType':
                                    extraSc1 = """chart.yAxis[0].update({ type: '""" + \
                                               extraScriptButton[0][
                                                       extraScriptButton[0].keys()[1]] + """'});"""
                                    extraSc2 = """chart.yAxis[0].update({ type: '""" + \
                                               extraScriptButton[0][
                                                       extraScriptButton[0].keys()[0]] + """'});"""
                    ...
                    extraScriptButton = """\n
                                                 ...
                                                 var chart = $('#container""" + str(
                            self.__class__.count) + """').highcharts();

                                                 if(document.getElementById('button""" + str(
                            self.__class__.count) + """').name == 1)
                                                 {
                                                    document.getElementById('button""" + str(
            ...
            if sortableAccordingToTable is None:
                    ...
                    try:
                            sortableAccordingToTableDataY = json.dumps(
                                    sortableAccordingToTableDataY).replace('"', "")
                    except Exception, e:
                            sortableAccordingToTableDataY = sortableAccordingToTableDataY
                    ...
                    sortableAccordingToTable = """
                            ...
                            tableName) + """').getElementsByTagName("th");

                                                //console.log('x', x);

                                                var specInd  = parseInt(""" + str(
                            sortableAccordingToTableIndexWithTrackTitle) + """);
                            ...
                            sortableAccordingToTableDataY) + """;
                                                ...
                                                $(document.getElementById('""" + str(tableName) + """').getElementsByTagName("th")[el]).click(function(e)
                                                {
                                                    ...
                                                    //depthYdata = depthOfData(""" + str(
                            sortableAccordingToTableDataY) + """);
                                                    depthYdata = depthOfData(resTabJS);

                                                    console.log('1 ---- ', resTabJS, depthYdata );

                                                    var xx = document.getElementById('""" + str(
                            tableName) + """').getElementsByTagName("td");
                            ...
                            tableName) + """').getElementsByTagName("th");
                                                    ...
                                                    for (var i = 1; i < x.length; i++)
                                                    {
                                                        ...
                                                        if (containerEl == i)
                                                        {
                                                            ...
                                                            //console.log('1', containerName, el, '""" + str(
                            tableName) + """');

                                                            classNameTH = document.getElementById('""" + str(
                            tableName) + """').getElementsByTagName("th")[el].className;
                                                            ...
                                                            if (chart != undefined)
                                                            {
                                                                ...
                                                                if (classNameTH.replace(/\s+/g, '') == 'header sorttable_sorted_reverse'.replace(' ', ''))
                                                                {
                                                                    ...
                                                                    if (depthYdata==1)
                                                                    {
                                                                        sL = sortTwoLists(resTabJS, """ + str(
                            categories) + """, namesFromTable, 'asc');
                                                                    }
                                                                    else
                                                                    {
                                                                        sL = sortTwoLists(resTabJS[elN], """ + str(
                            categories) + """, namesFromTable, 'asc');
                                                                    }
                                                                ...
                                                                else if(classNameTH.replace(/\s+/g, '')== 'header sorttable_sorted'.replace(' ', ''))
                                                                {
                                                                    ...
                                                                    if (depthYdata==1)
                                                                    {
                                                                        console.log('1', resTabJS, namesFromTable);
                                                                        sL = sortTwoLists(resTabJS, """ + str(
                            categories) + """, namesFromTable, 'desc');
                                                                    }
                                                                    else
                                                                    {
                                                                        console.log('2', resTabJS[elN], namesFromTable);
            ...
            if type == 'largeHeatmap':
                    ...
                    return '{0}{1}{2}{3}{4}{5}'.format(button, jsCodeShowChartClickOnLink,
                                                       container,
                                                       functionJS1, dataY, functionJS2)
            else:
                    return '{0}{1}{2}{3}{4}{5}'.format(button, jsCodeShowChartClickOnLink,
                                                       container, functionJS1, dataY, functionJS2)
            ...
            if len(dataY) > 0:
                    ...
                    if sortableAccordingToTableDataY is None:
                            ...
                            if addTable == True:
                                    if tableName is None:
                                            tableName = 'resultsTable'
                                    graph += self.addTable(titleText, tableName=tableName,
                                                           option=2,
                                                           indexSpecial=sortableAccordingToTableIndexWithTrackTitle)
                                    addTable = 'option2'
    ...
    def drawLineChartMultiYAxis(self,
            ...
            if len(dataY) > 0:
                    ...
                    graph = self._draw(
                            ...
                            tooltipVal=tooltipVal,
                            reversed=reversed,
                            minY=minY, plotLines=plotLines, categoriesY=None,
                            plotLinesName=plotLinesName,
                            plotBands=None,
                            plotBandsColor=None
                    )
    ...
    def drawPieChart(self, dataY, height=None, addOptions=None,
            ...
            if len(dataY) > 0:
                    ...
                    graph = self._draw(
                            ...
                            sortableAccordingToTableIndexWithTrackTitle=None,
                            plotOptions=None,
                            tooltipVal=tooltipVal, reversed=None, minY=None, plotLines=None,
                            categoriesY=None, plotLinesName=None,
                            plotBands=None,
                            plotBandsColor=None
                    ...
                    if dataYdepth >= 2:
                            for eldY in range(0, len(dataY)):
                                    ...
                                    graph += self.drawColumnChart(dataY[eldY], height=height,
                                                                  ...
                                                                  sortableAccordingToTableIndexWithTrackTitle=sortableAccordingToTableIndexWithTrackTitle,
                                                                  plotOptions=plotOptions,
                                                                  minY=minY, plotLines=pLine,
                                                                  plotLinesName=pLineName,
                                                                  plotBands=None,
                                                                  plotBandsColor=None
                                                                  )
                    else:
                            graph += self.drawColumnChart(dataY, height=height,
                                                          addOptions=addOptions,
                                                          tickInterval=tickInterval,
                                                          label=label, lineWidth=lineWidth,
                                                          titleText=titleText,
    ...
    def drawBubbleCharts(self,
            ...
            if len(dataY) > 0:
                    ...
                    if dataYdepth >= 2:
                            ...
                            graph += self.drawBubbleChart(dataY, height=height,
                                                          addOptions=addOptions,
                                                          tickInterval=tickInterval,
                                                          label=label, lineWidth=lineWidth,
                                                          titleText=titleText,
            ...
            if len(dataY) > 0:
                    ...
                    if dataYdepth >= 2:
                            for eldY in range(0, len(dataY)):
                                    ...
                                    graph += self.drawPieChart(dataY[eldY], height=height,
                                                               addOptions=addOptions,
                                                               seriesType=seriesType,
                                                               seriesName=sN,
                                                               showInLegend=showInLegend,
            ...
            if len(dataY) > 0:
                    ...
                    if dataYdepth > 2:
                            ...
                            for eldY in range(0, len(dataY)):
                                    ...
                                    graph += self.drawLineChart(dataY[eldY], height=height,
                                                                addOptions=addOptions,
                                                                tickInterval=tickInterval,
                                                                tickMinValue=tickMinValue,
                                                                label=label, lineWidth=lineWidth,
                            ...
                            graph += self.drawLineChart(dataY, height=height,
                                                        addOptions=addOptions,
                                                        tickInterval=tickInterval,
                                                        tickMinValue=tickMinValue,
                                                        label=label, lineWidth=lineWidth,
    ...
    class dataTransformer(object):
            ...
            def changeDictIntoListsByNumber(self, number=None):
                    ...
                    if number is not None:
                            number = int(number)
                            dataList = [data[x:x + number] for x in xrange(0, len(data), number)]
                            categoriesList = [categories[x:x + number] for x in
                                              xrange(0, len(categories), number)]
                    else:
                            return None, None, None
