...
class CongloProtoTool(GeneralGuiTool):
    ...
    def getOptionsBoxOverlapMeasure(cls, prevChoices):
        if prevChoices.teststatType and prevChoices.teststatType[cls.OVERLAP]:
            return OrderedDict([(cls.COUNTS, True), (cls.BASES, True)])
    ...
    def execute(cls, choices, galaxyFn=None, username=''):
        ...
        print HtmlCore().begin(reloadTime=7)
        # TODO: REMOVE
        # LOAD_PICKLES = True
        #
        # if LOAD_PICKLES:
    ...
    def parseAdvancedChoices(cls, choices):
        ...
        if choices.restrictRegions in [cls.WHOLE_GENOME, None]:
            ...
            if choices.restrictedRegionFileUpload in [None, '', []]:
                ...
                fn = TrackFile(ExternalTrackManager.extractFnFromGalaxyTN(choices.restrictedRegionFileUpload), ExternalTrackManager.extractNameFromHistoryTN(choices.restrictedRegionFileUpload))
