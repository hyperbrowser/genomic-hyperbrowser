...
class TrackFindClientTool(GeneralGuiTool):
    ...
    def getInputBoxNames(cls):
        ...
        """
        return [('Select repository: ', 'selectRepository'),
                ('Select attributes: ', 'selectAttributes'),
                ('Select attribute value: ', 'selectAttributeValue')]
    ...
    @classmethod
    def getOptionsBoxSelectRepository(cls):  # Alt: getOptionsBox1()
        """
    ...
    @classmethod
    def getOptionsBoxSelectAttributes(cls, prevChoices):  # Alt: getOptionsBox2()
        """
    ...
    @classmethod
    def getOptionsBoxSelectAttributeValue(cls, prevChoices):
        tfm = TrackFindModule()
        values = tfm.getAttributeValues(prevChoices.selectRepository, prevChoices.selectAttributes)
...
# @classmethod
    ...
    def execute(cls, choices, galaxyFn=None, username=''):
        ...
        tfm = TrackFindModule()
        values = tfm.getData(choices.selectRepository, choices.selectAttributes, choices.selectAttributeValue)


        print 'You chose: ' + ', '.join([choices.selectRepository, choices.selectAttributes, choices.selectAttributeValue])
        print
        print values
