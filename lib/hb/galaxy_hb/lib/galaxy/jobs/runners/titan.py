...
class TitanJobRunner( object ):
    ...
    def __init__( self, app ):
        ...
        self.queue = Queue()
        self.threads = []
        nworkers = app.config.titan_job_queue_workers
    ...
    def run_job( self, job_wrapper ):
        job_wrapper.set_runner( 'titan:///', None )
        ...
        if command_line:
            ...
            try:
                ...
                job_wrapper.set_runner( 'titan:///', proc.pid )
    ...
    def shutdown( self ):
        ...
        log.info( "titan job runner stopped" )
