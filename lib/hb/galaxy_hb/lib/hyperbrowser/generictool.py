...
class GenericToolController(BaseToolController):
    ...
    def __init__(self, trans, job):
        ...
        #self._monkeyPatchAttr('sessionKey', self.galaxy.getSessionKey())
    ...
    def action(self):
        self.options = []
        reset = self.resetAll
        #self.prototype.username = self.galaxy.getUserName()#params['userEmail']# if 'userEmail' in self.params else ''
        #if not self.prototype.username:
        #    self.prototype.username = 'trengere@gmail.com'
