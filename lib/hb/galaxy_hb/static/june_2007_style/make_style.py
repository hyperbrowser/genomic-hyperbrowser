...
templates = [ ( "base.css.tmpl", "base.css" ),
              ( "embed_item.css.tmpl", "embed_item.css" ),
...
# HB additional css template
templates += [ ( "hb_base.css.tmpl", "hb_base.css" ) ]
templates += [ ( "hb_tools.css.tmpl", "hb_tools.css" ) ]
templates += [ ( "welcome.css.tmpl", "welcome.css" ) ]
templates += [ ( "image_zoom.css.tmpl", "image_zoom.css" ) ]
...
# HB additional images
images += [ ( "./gradient.py 9 1000 $welcome_bg_top - $welcome_bg_bottom 0 0 $welcome_bg_bottom 1 1", "welcome_bg.png" ) ]
...
if __name__ == "__main__":
    compile_colors = None
    if len(sys.argv) == 3: # has params
        ini_file, out_dir  = sys.argv[1:]
    elif len(sys.argv) == 4: # has params
        ini_file, out_dir, compile_colors  = sys.argv[1:]
    else:
        cwd = os.getcwd() # default settings
        ini_file, out_dir = cwd + "/blue_colors.ini", cwd + "/blue"

    if compile_colors is None:
