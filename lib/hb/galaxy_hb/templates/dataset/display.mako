...
<%def name="render_item( data, data_to_render )">
    ...
    %else:
	<iframe style="width:100%;height:95%;border:0" src="${h.url_for( controller='/dataset', action='display', dataset_id=trans.security.encode_id( data.id ))}"></iframe>
    %endif
</%def>
...
<%def name="center_panel()">
    ...
    <div class="unified-panel-body">
        <div style="overflow: auto; height: 100%;">        
            <div class="page-body" style="height:90%">
